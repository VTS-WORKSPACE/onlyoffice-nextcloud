...
return [
    "routes" => [
       ...
       ["name" => "editor#restore", "url" => "/ajax/restore", "verb" => "POST"],
       ["name" => "settings#save_address", "url" => "/ajax/settings/address", "verb" => "POST"],
       ["name" => "settings#save_common", "url" => "/ajax/settings/common", "verb" => "POST"],
       ["name" => "settings#save_watermark", "url" => "/ajax/settings/watermark", "verb" => "POST"],
       ["name" => "settings#get_settings", "url" => "/ajax/settings", "verb" => "GET"],
       ["name" => "settings#clear_history", "url" => "/ajax/settings/history", "verb" => "POST"],
       ["name" => "template#add_template", "url" => "/ajax/template", "verb" => "POST"],
       ["name" => "template#delete_template", "url" => "/ajax/delete-template", "verb" => "POST"],
       ["name" => "template#get_templates", "url" => "/ajax/templates", "verb" => "GET"],
    ],
    "ocs" => [
